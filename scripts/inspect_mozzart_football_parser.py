"""This is the inspect_mozzart_football_parser.py file.

Author: Data-Amigo
Date: 2026-05-02
Description:
This script fetches the live Mozzart football page with the shared browser
layer, parses the stable football fields, and prints a structured preview for
...
from ganji_mtaani_agent.parsers.mozzart import parse_mozzart_football
...
# =============================================================================
def main() -> None:
    """Fetch the live Mozzart football page and inspect parsed rows."""

    parser = argparse.ArgumentParser(description="Inspect the Mozzart football parser output.")
    ...
    target = get_source_target(source, "football_live")
    ...
    parsed_rows = parse_mozzart_football(result.html)
