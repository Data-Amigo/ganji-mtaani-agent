"""This is the inspect_betika_football_parser.py file.

Author: Data-Amigo
Date: 2026-05-02
Description:
This script fetches the live Betika football page with the shared browser
layer, parses the stable football odds fields, and prints a structured preview
...
from ganji_mtaani_agent.parsers.betika import parse_betika_football
...
# =============================================================================
def main() -> None:
    """Fetch the live Betika football page and inspect parsed rows."""

    parser = argparse.ArgumentParser(description="Inspect the Betika football parser output.")
    ...
    parsed_rows = parse_betika_football(result.html)
