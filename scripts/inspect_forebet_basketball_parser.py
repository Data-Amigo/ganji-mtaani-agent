"""This is the inspect_forebet_basketball_parser.py file.

Author: Data-Amigo
Date: 2026-04-29
Description:
This is a small developer script that runs the first Forebet basketball parser
...
# =============================================================================
def main() -> None:
    """Run the first basketball parser against a saved Forebet snapshot."""

    parser = argparse.ArgumentParser(description="Inspect parsed Forebet basketball rows.")
    parser.add_argument("snapshot_path", help="Path to the saved basketball HTML snapshot file.")
    ...
    predictions = parse_forebet_basketball(html)
