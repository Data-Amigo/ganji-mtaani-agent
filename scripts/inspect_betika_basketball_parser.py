"""This is the inspect_betika_basketball_parser.py file.

Author: Data-Amigo
Date: 2026-05-02
Description:
This script fetches the live Betika basketball page with the shared browser
layer, parses the stable basketball odds fields, and prints a structured
preview for development and verification.
"""
...
from ganji_mtaani_agent.parsers.betika import parse_betika_basketball
...
# =============================================================================
def main() -> None:
    """Fetch the live Betika basketball page and inspect parsed rows."""

    parser = argparse.ArgumentParser(description="Inspect the Betika basketball parser output.")
    ...
    parsed_rows = parse_betika_basketball(result.html)
